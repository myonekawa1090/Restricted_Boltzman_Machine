...
class DeepBeliefNet10:
    ...
    def train(self, data, target, epochs=15, learning_rate=0.1 , monitor=2000):
        ...
        for epoch in range(epochs):
            ...
            y = sigmoid(np.dot(z8 , self.W9) + self.out_bias)
            ...
            h8_delta = np.dot(self.W9 , out_delta) * dsigmoid(z8)
            ...
            h7_delta = np.dot(self.W8 , h8_delta) * dsigmoid(z7)
            ...
            h6_delta = np.dot(self.W7 , h7_delta) * dsigmoid(z6)
            ...
            h5_delta = np.dot(self.W6 , h6_delta) * dsigmoid(z5)
            ...
            h4_delta = np.dot(self.W5 , h5_delta) * dsigmoid(z4)
            ...
            h3_delta = np.dot(self.W4 , h4_delta) * dsigmoid(z3)
